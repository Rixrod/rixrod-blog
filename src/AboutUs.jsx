                ...
                {data &&
                  ...
                  data.ads.map((ad) => (
                    <ul
                      key={ad._id}
                      role="list"
                      className="divide-y mt-9  divide-gray-900 border-b border-t border-gray-200"
                    >
                      <img src={ad.imgUrl} alt={ad.name} className="" />
                    </ul>
                  ))}
              </div>
                      ...
                      <div className="lg:col-span-4">
                        {data &&
                          ...
                          data.ads.map((ad) => (
                            <div
                              key={ad._id}
                              className="aspect-h-1 sm:aspect-h-12 sm:aspect-w-5 "
                            >
                              <img
                                src={ad.imgUrl}
                                alt={ad.name} // Add alt text for accessibility
                                className=" " // Center the image
                              />
                            </div>
                          ))}
                      </div>
